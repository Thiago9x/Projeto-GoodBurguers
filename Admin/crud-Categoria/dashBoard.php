            ...
            <table id="tblConsulta" >
                ...
                <tr id="tblLinhas">
                    ...
                    <td class="tblColunas registros">
                        ...
                        <a href="./controles/editarDadosClientes.php?id=<?=$rsCategorias['idCategoria']?>">
                            <img src="img/edit.png" alt="Editar" title="Editar" class="editar">
                        </a>
                        <a onclick="return confirm('Tem certeza que deseja ecluir?');" href="./controles/excluirDadosClientes.php?id=<?=$rsCategorias['idCategoria']?>">
                            <img src="img/trash.png" alt="Excluir" title="Excluir" class="excluir">
                        </a>
